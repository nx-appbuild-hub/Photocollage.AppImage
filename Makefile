...
all: clean
	...
	apprepo --destination=$(PWD)/build appdir boilerplate python3.8 python3.8-dev python3.8-psutil \
										...
										openssl libffi7 intltool libgudev-1.0-0 libffi libgudev python3-pil \
										python3-distutils python3-distutils-extra python3-gi python3-six \
										python3-pyqt5 python3-cairo gir1.2-gudev-1.0 libgudev \
										libatk1.0-0 libatk-bridge2.0-0 libgtk-3-0 python3-gi-cairo
	...
	echo '  *)   $${APPDIR}/bin/python3.8 $${APPDIR}/vendor/bin/photocollage $${@} ;;' 				>> $(PWD)/build/Boilerplate.AppDir/AppRun
	...
	export ARCH=x86_64 && $(PWD)/bin/appimagetool.AppImage  $(PWD)/build/Boilerplate.AppDir $(PWD)/Photocollage.AppImage
	chmod +x $(PWD)/Photocollage.AppImage
